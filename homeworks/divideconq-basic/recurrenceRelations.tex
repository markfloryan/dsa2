...
\question[2]{
Show that $T(n)=2T(\frac{n}{2})+n \in \Omega(nlog(n))$. \emph{Note: We are using big-omega here, so your inequality will use $T(n) \geq c*n$}.
}
...
\question[2]{
Show that $T(n)=4T(\frac{n}{2})+n^2 \in \Theta(n^2)$. You'll need to subtract off a lower-order term to make the induction work here.
}
