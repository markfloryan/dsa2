...
\question[1]{Answer the first short-answer question that was selected (With the smallest question number).}

\answer[1.75in]{
	
}

\question[1]{Answer the second short-answer question that was selected (With the larger question number).}
